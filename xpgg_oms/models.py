...
class AppRelease(models.Model):
    ...
    app_svn_co_path = models.CharField(max_length=200, verbose_name='SVN/GIT检出目录', blank=True, null=True)
    ...
    app_git_url = models.CharField(max_length=200, verbose_name='git地址', blank=True, null=True)
    app_git_user = models.CharField(max_length=20, verbose_name='git账户', blank=True, null=True)
    app_git_password = models.CharField(max_length=20, verbose_name='git密码', blank=True, null=True)
    app_git_branch = models.CharField(max_length=20, verbose_name='git分支', blank=True, null=True)
    app_git_co_status = models.NullBooleanField(max_length=20, verbose_name='git检出状态', blank=True, null=True)
...
class ServerList(models.Model):
    ...
    server_type = models.CharField(choices=Server_Type, max_length=20, verbose_name='服务器类型', blank=True, null=True)
    localhost = models.CharField(max_length=50, verbose_name='主机名', blank=True, null=True)
    ip = models.CharField(max_length=200, verbose_name='IP地址', blank=True, null=True)
    system_issue = models.CharField(max_length=50, verbose_name='系统版本', blank=True, null=True)
